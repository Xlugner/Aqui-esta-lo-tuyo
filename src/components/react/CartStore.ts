...
// Totales por moneda
export const totalsByCurrency = computed(cartItems, (items): CartTotals => {
...
// Total general (convertido a una moneda base si es necesario)
export const totalPrice = computed(totalsByCurrency, (totals) => {
  // Por ahora, simplemente sumamos ambos totales
  // En el futuro podrías agregar conversión de moneda aquí
