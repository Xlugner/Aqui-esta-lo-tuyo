...
import { getStoreConfig, getCategories, getHeroSection, getSupabaseImage, type Category, type StoreConfig, type HeroSection } from '../../lib/supabase';
    ...
    <>
      ...
      >
        ...
        <div className="relative bg-hero-gradient h-64 overflow-hidden">
          ...
          {!heroSection?.images?.[0] && storeConfig?.logo_url && (
        ...
        <div className="flex flex-col h-[calc(100%-16rem)]">
          ...
          <div className="p-6 border-b">
            <h3 className="text-xl font-bold text-neutral-800 mb-4">
              {storeConfig?.store_name || 'Tienda Online'}
            </h3>
